...
#             "Effect": "Allow",
#             "Principal": {
#                 "AWS": "arn:aws:iam::783764596465:user/admin"
#             },
#             "Action": "sts:AssumeRole"
#         }
#     ]
...
#             "Effect": "Allow",
#             "Action": "sts:AssumeRole",
#             "Resource": "arn:aws:iam::783764596465:role/Dev"
#         }
#     ]
# }
#
...
import uuid
bucket_name = f"2xycs6620"  # Use a random UUID to ensure the bucket name is unique
...
with open('1.jpg', 'rb') as img_file:
    bucket.put_object(Key='1.jpg', Body=img_file)
